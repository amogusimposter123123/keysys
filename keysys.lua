...
local plr = game.Players.LocalPlayer--чекает локал плеера(тебя)
...
plr:Kick("[!] = Krnl is not Whitelisted for this Script!")
else
if electron then--чекает если заинжектин електрон
plr:Kick("[!] = Electron is not Whitelisted for this Script!")
end
end
end
end
